...
function adduser() {
    ...
    xhr.open("POST", "./function/studentFunction.php", true);
                ...
                if (xhr.readyState === 4) {
                    if (xhr.status === 200) {
                        ...
                        if (typeof response === "object" && response !== null) {
                            document.getElementById('hiddenID').value=response.studentID;
                            document.getElementById('updateName').value=response.Name;
                            document.getElementById('updatusername').value=response.username;
                            document.getElementById('updatebirth').value=response.birth;
...
function updateInfoStudent(){
    var StudentId={
                 ...
                 username: document.getElementById('updatusername').value,
